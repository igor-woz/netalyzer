...
Centralized constants and configuration values for network traffic analysis

Groups all variables into named classes to avoid hardcoded values all around the codebase
"""
...
class Ports(IntEnum):
    """
    standard network protocol port numbers for identification
    """
    HTTP = 80
    HTTPS = 443
    DNS = 53
...
class TimeConstants:
    ...
    SEC_PER_HR: Final[int] = 3600

class ByteUnits:
    """
    constants for byte unit conversion
    """
...
class CaptureDefaults:
    """
    default values for packet capture
    """
